...
"        <CONFIGURATION isDebug=\"0\" name=\"Release\" targetName=\"%RELEASE_DLL_NAME%\" headerPath =\"%FAUST_HEADER_PATH%\" libraryPath=\"%WIN_STATIC_LIB_FOLDER_R64%\" binaryPath=\"dll\"\r\n"
...
"<XCODE_MAC targetFolder=\"Builds/MacOSX\" extraDefs=\"%EXTRA_DEFINES_OSX%\" extraLinkerFlags=\"%OSX_STATIC_LIBS%\" externalLibraries=\"%OSX_EXTERNAL_LIBRARIES%\" extraCompilerFlags=\"-Wno-reorder -Wno-inconsistent-missing-override -fno-aligned-allocation -ffp-contract=off\" xcodeValidArchs=\"arm64,arm64e,x86_64\">\r\n"
"      <CONFIGURATIONS>\r\n"
"        <CONFIGURATION isDebug=\"1\" name=\"Debug\" osxArchitecture=\"64BitIntel\" headerPath=\"%FAUST_HEADER_PATH%\"\r\n"
"                       libraryPath=\"%OSC_STATIC_LIB_FOLDER_DEBUG%\" binaryPath=\"dll\" targetName=\"%DEBUG_DLL_NAME%\" customXcodeFlags=\"CODE_SIGNING_ALLOWED=NO\"/> \r\n"
...
"                       libraryPath=\"%OSC_STATIC_LIB_FOLDER_RELEASE%\" binaryPath=\"dll\" customXcodeFlags=\"CODE_SIGNING_ALLOWED=NO\" targetName=\"%RELEASE_DLL_NAME%\"/>\r\n"
"      </CONFIGURATIONS>\r\n"
"      <MODULEPATHS>\r\n"
"        <MODULEPATH id=\"juce_gui_basics\" path=\"%JUCE_PATH%\"/>\r\n"
"        <MODULEPATH id=\"juce_graphics\" path=\"%JUCE_PATH%\"/>\r\n"
