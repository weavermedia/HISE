...
hise::ProcessorMetadata WaveSynth::createMetadata()
{
	...
	return ModulatorSynth::createBaseMetadata()
		...
		.withParameter(Par(Pan1)
			...
			.withSliderMode(HiSlider::Pan, Range(-100.0, 100.0))
			.withDefault(0.0f))
	...
	.withParameter(Par(PulseWidth1)
		...
		.withParameter(Par(SemiTones2)
			...
			.withSliderMode(HiSlider::Discrete, Range(-12.0, 12.0, 1.0))
			.withDefault(0.0f))
		.withParameter(Par(StartPhase1)
			.withId("StartPhase1")
			.withDescription("The initial phase offset for the first oscillator")
			.withSliderMode(HiSlider::NormalizedPercentage, {})
			.withDefault(0.0f))
		.withParameter(Par(StartPhase2)
			.withId("StartPhase2")
			.withDescription("The initial phase offset for the second oscillator")
			.withSliderMode(HiSlider::NormalizedPercentage, {})
			.withDefault(0.0f))
